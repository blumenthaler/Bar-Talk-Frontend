        ...
        const comments = this.props.comments.comments.data.filter(comment => (this.props.recipe.relationships.comments.data.map(comment => comment.id)).includes(comment.id.toString()))
            ...
            return (
                ...
                <div>
                    ...
                    users={users} /><br />
                    {!this.state.showingCommentForm ? <NewCommentButton triggerCommentForm={this.triggerCommentForm}/> : <CommentInput user={this.props.currentUser} recipe={this.props.recipe} triggerCommentForm={this.triggerCommentForm}/> }
                </div>
                </>
            )
            }    
